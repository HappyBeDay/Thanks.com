			...
			<div class="mb-3">
				...
				<textarea class="form-control" rows="5" name="content" id="content" placeholder="내용을 입력해 주세요"></textarea>
						<c:choose>
								...
								<c:otherwise>
									<input type="hidden" value=${boardtitle } name="job">
									<input type="hidden" value=${boardcontent } name="ref">
									<input type="hidden" value=${boardpic } name="step">
									<input type="hidden" value=${boarddate } name="lev">
									<input type="hidden" value=${boardnum } name="pnum">
								</c:otherwise>
							</c:choose>
			</div>
