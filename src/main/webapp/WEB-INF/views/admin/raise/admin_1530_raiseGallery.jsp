	...
	<div id="layoutSidenav">
		...
		<div id="layoutSidenav_content">
			...
			<div class="container-fluid px-4">
				<h1 class="mt-4">양육 갤러리 관리 페이지</h1>
				...
				<div class="card mb-4">
									...
									<td class="actions-cell">
										<div class="buttons right nowrap">
											<button class="button btn"
												style="font-size: 12px; background-color: #198754; color: white;"
												data-target="sample-modal-2" type="button">
												<span class="icon"><i class="far fa-edit"></i></span>
											</button>
											<button class="button btn"
												style="font-size: 12px; background-color: #dc3545; color: white;"
					...
					<button type="button" class="btn btn-primary" style="margin-left: 10px; float: right;">추가</button>
						</table>
					</div>
				</div>
			</div>
