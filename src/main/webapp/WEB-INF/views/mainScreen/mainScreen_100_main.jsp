		...
		<div class="container px-4 px-lg-5 h-100">
			<div
				...
				<div class="col-lg-8 align-self-end">
					<h1 class="text-black font-weight-bold" style="font-size: 50px;">동물들이
						뛰어노는 세상을 꿈꿉니다.</h1>
				</div>
		...
		<div class="container px-4 px-lg-5">
			<div class="row gx-4 gx-lg-5 justify-content-center">
				<div class="col-xl-4 col-lg-5">
					<img class="img-fluid mb-3 mb-lg-0" src="../assets/img/intro.png"
						alt="...">
				</div>
				<div class="col-xl-8 col-lg-7">
					...
					<p class="text-white-75 mb-4">저희는 유기동물들이 새로운 가족을 만날 수 있도록 도움을
						드리고 있습니다.<br> 동물과 공존하는 행복한 세상! 여러분의 관심과 사랑이 함께하면 현실이 됩니다.<br> 유저들이 언제든
						사이트에 방문하여 입양, 실종, 양육에 대한 고민상담을 커뮤니티에서 다른 유저들과 함께 하며, 세미나 신청을 통해 직접
						관심있는 강의를 듣고 전문 지식을 쌓으며, 실제로 입양하거나 양육 서비스를 통해 도움을 주며 사회에 공헌할 수 있는
						편안하고 여유로운 곳.<br> 이런 곳을 동물병원 또는 애완샵에서 근무하고 있는 유저들의 친구와 비유하여 저희 웹사이트가
						전달하고자 하는 컨셉입니다.</p>
				</div>
			</div>
		</div>
